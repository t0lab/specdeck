...
- **Reduced motion**: animation "đang chạy" và hiệu ứng kéo-thả phải giảm/tắt khi người dùng bật prefers-reduced-motion. *(Superseded 2026-06-26: reduced-motion đã gỡ product-wide — xem 003-projects Refinements R2.)*
...
- **FR-028**: Toàn bộ thao tác chính (điều hướng, mở chi tiết, kéo-thả, chuyển tab) MUST dùng được bằng bàn phím với focus nhìn thấy được, và MUST tôn trọng prefers-reduced-motion. *(Mệnh đề reduced-motion superseded 2026-06-26 — đã gỡ product-wide, xem 003-projects Refinements R2.)*
